...
const FinalPage = () => {
	...
	const modalClass = modal
		? 'final-page__modal'
		: 'final-page__modal final-page__modal--closed'
	if (orderApproved) {
		return (
				...
				<div className="order-page__wrapper">
					...
					<div className=" order-page__container order-page__content">
						<div className="order-page__left-container">
							<div className="final-page__order">
								<div className="final-page__order-info">
									<h2 className="final-page__order-alert">
										Ваш заказ подтверждён
									</h2>
									<p className="final-page__order-header">Hynday, {car.name}</p>
									<p className="final-page__order-plate">K 761 HA 73</p>
									<p className="final-page__order-info">
										Топливо{' '}
										<span className="final-page__order-value">100%</span>
									</p>
									<p className="final-page__order-info">
										Доступна с{' '}
										<span className="final-page__order-value">
											12.06.2019 12:00
										</span>
									</p>
								</div>
								<img
									className="final-page__order-image"
									alt="иконка машины"
									src={car.thumbnail}
								></img>
							</div>
						...
						<div className="order-page__right-container">
							...
							<button
								className="button order-page__button order-page__button--back"
								onClick={() => setOrderApproved(false)}
							>
								Отменить
							</button>
						</div>
		...
		<section className="final-page order-page">
			...
			<div className="order-page__wrapper">
				...
				<div className=" order-page__container order-page__content">
					<div className="order-page__left-container">
						<div className="final-page__order">
							<div className="final-page__order-info">
								...
								<p className="final-page__order-plate">K 761 HA 73</p>
								<p className="final-page__order-info">
									Топливо <span className="final-page__order-value">100%</span>
								</p>
								<p className="final-page__order-info">
									Доступна с{' '}
									<span className="final-page__order-value">
					...
					<div className="order-page__right-container">
						...
						<button
							className="button order-page__button"
			...
			<div className={modalClass}>
				...
				<div className="final-page__modal-controls">
					<button
						className="button final-page__modal-button final-page__modal-button--aproove"
						onClick={() => {
					...
					<button
						className="button final-page__modal-button final-page__modal-button--back"
