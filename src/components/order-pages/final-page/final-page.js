            ...
            <BurgerMenu/>
                <div className="order-page__wrapper">
                    ...
                    <div className=" order-page__container order-page__content">
                        ...
                        <div className="order-page__right-container">
                            ...
                            <button className={buttonClass} onClick={() => setModal(true)}>Заказать</button>
                        </div>
                    </div>
                ...
                <div className={modalClass}>
                    ...
                    <div className="final-page__modal-controls">
                        <button className="button final-page__modal-button final-page__modal-button--aproove">Подтвердить</button>
