...
const BurgerMenu = ({ substrate }) => {
	...
	const burgerMenuClass = menuOpened
		? 'burger-menu__opened'
		: 'burger-menu__closed'
	...
	if (menuOpened && menuTriggered) {
		...
		burgerIconClass =
			'burger-menu__icon burger-menu__icon--opened burger-menu__icon--burger-mobile'
	...
	return (
		<div className="burger-menu container">
			...
			<button className="burger-menu__lang" aria-label="change language">
				Eng
			</button>
			<div className={burgerMenuClass}>
				...
				<div className={substrateClass}></div>
			</div>
		</div>
	)
}
